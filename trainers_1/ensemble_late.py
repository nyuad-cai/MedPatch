...
class EnsembleLateTrainer(Trainer):
    def __init__(self, 
        train_dl, 
        val_dl, 
        args,
        ...
        super(EnsembleLateTrainer, self).__init__(args)
    ...
    def train_epoch(self):
        ...
        for i, (x, img, dn, rr, y_ehr, y_cxr, seq_lengths, pairs) in enumerate (self.train_dl):
            ...
            y_fused_pred = torch.mean(torch.stack([y_fused_early, y_fused_joint, y_fused_late], dim=0), dim=0)
