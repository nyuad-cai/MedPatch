...
# or use healnet-raw in the fusion_type if you want the original healnet implementation
# The difference is that we use an encoder infused implementation of healnet in the appendix results