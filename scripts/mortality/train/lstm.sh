...
--mode train \
--epochs 50 --batch_size 16 --lr 0.0000001 \
--num_classes 1 \
--modalities EHR \
--order EHR \
--H_mode lstm \
...
--load_rr checkpoints/in-hospital-mortality/unimodal/best_checkpoint_unimodal_1e-06_in-hospital-mortality_RR.pth.tar \
--save_dir checkpoints \
--task in-hospital-mortality \
--labels_set in-hospital-mortality
