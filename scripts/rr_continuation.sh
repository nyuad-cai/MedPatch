...
--mode train \
--epochs 23 --batch_size 16 --lr 0.00021436444023292757 \
--num_classes 25 \
--modalities EHR-RR \
...
--output_dim_dn 512 \
--data_pairs paired \
--pretrained_model '/scratch/baj321/MSMA/checkpoints/phenotyping/unimodal_rr/best_checkpoint_0.0008574577609317103_phenotyping_unimodal_rr_EHR-RR_paired.pth.tar'