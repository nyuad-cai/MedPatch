...
def args_parser():
    ...
    parser.add_argument('--retrieve_cxr', default="recent", type=str, help='recent or all')
    parser.add_argument('--load_cxr', type=str, default=None, help='state dir path')
    parser.add_argument('--load_ehr', type=str, default=None, help='state dir path')
    parser.add_argument('--load_dn', type=str, default=None, help='state dir path')
    parser.add_argument('--load_rr', type=str, default=None, help='state dir path')
    
    parser.add_argument('--load_cxr_1', type=str, default=None, help='state dir path')
    parser.add_argument('--load_ehr_1', type=str, default=None, help='state dir path')
    parser.add_argument('--load_dn_1', type=str, default=None, help='state dir path')
    parser.add_argument('--load_rr_1', type=str, default=None, help='state dir path')
    
    parser.add_argument('--load_cxr_2', type=str, default=None, help='state dir path')
    parser.add_argument('--load_ehr_2', type=str, default=None, help='state dir path')
    parser.add_argument('--load_dn_2', type=str, default=None, help='state dir path')
    parser.add_argument('--load_rr_2', type=str, default=None, help='state dir path')
    
    parser.add_argument('--load_cxr_3', type=str, default=None, help='state dir path')
    parser.add_argument('--load_ehr_3', type=str, default=None, help='state dir path')
    parser.add_argument('--load_dn_3', type=str, default=None, help='state dir path')
    parser.add_argument('--load_rr_3', type=str, default=None, help='state dir path')
    
    parser.add_argument('--ablation', type=str, default=None, help='state dir path')
    
    parser.add_argument('--inspect_model', type=str, default=None, help='state dir path')
    parser.add_argument('--stat_test', type=str, default=None, help='state dir path')
    
    parser.add_argument('--load_early', type=str, default=None, help='state dir path')
    parser.add_argument('--load_joint', type=str, default=None, help='state dir path')
    parser.add_argument('--load_late', type=str, default=None, help='state dir path')
    parser.add_argument('--load_model_1', type=str, default=None, help='state dir path')
    parser.add_argument('--load_model_2', type=str, default=None, help='state dir path')
    parser.add_argument('--load_model_3', type=str, default=None, help='state dir path')
    ...
    parser.add_argument('--output_dim_rr', type=int, default=512, help='state dir path')
    parser.add_argument('--output_dim_dn', type=int, default=512, help='state dir path')
    parser.add_argument('--output_dim', type=int, default=512, help='state dir path')
    parser.add_argument('--image_size', type=int, default=384, help='state dir path')
    parser.add_argument('--patch_size', type=int, default=16, help='state dir path')
    parser.add_argument('--emb_dropout', type=float, default=0., help='state dir path')
    parser.add_argument('--pretrained_model', type=str, default=None, help='state dir path')
    parser.add_argument('--freeze', type=str, default=None, help='state dir path')
    parser.add_argument('--use_cls_token',  type=str, default='mean', help='Use CLS token instead of mean pooling')
    ...
    parser.add_argument('--calibration', type=str, default=None, help='calibrate or not')
    
    parser.add_argument('--run_method', type=str, default='fine_tune', help='train or eval for [fused_ehr, fused_cxr, uni_cxr, uni_ehr]')
    ...
    parser.add_argument('--fuser', type=str, default=None, help='LSTM or Transformer')
    ...
    parser.add_argument('--weight_high', type=float, default=1, help='weight for high confidence')
    parser.add_argument('--weight_low', type=float, default=1, help='weight for low confidence')
    parser.add_argument('--weight_late', type=float, default=1, help='weight for late')
    parser.add_argument('--ehr_confidence_threshold', type=float, default=0.3, help='confidence threshold')
    parser.add_argument('--cxr_confidence_threshold', type=float, default=0.3, help='confidence threshold')
    parser.add_argument('--rr_confidence_threshold', type=float, default=0.3, help='confidence threshold')
    parser.add_argument('--dn_confidence_threshold', type=float, default=0.3, help='confidence threshold')
    
    parser.add_argument('--patch_output_dim', type=int, default=512, help='patch dimensions')
